        ...
        <div style="background:var(--header-bg);padding:14px 18px 8px;flex-shrink:0;">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <div class="memo-style-selector" style="display:flex;gap:4px;">
              <button class="memo-style-btn active" data-style="list" style="padding:4px 10px;border-radius:var(--tab-radius);border:1px solid var(--border);background:var(--tab-active-bg);color:var(--tab-active-color);font-size:11px;font-weight:600;cursor:pointer;" title="リスト"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/></svg></button>
              <button class="memo-style-btn" data-style="grid" style="padding:4px 10px;border-radius:var(--tab-radius);border:1px solid var(--border);background:transparent;color:var(--sub);font-size:11px;font-weight:600;cursor:pointer;" title="グリッド"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M4 11h5V5H4v6zm0 7h5v-6H4v6zm6 0h5v-6h-5v6zm6 0h5v-6h-5v6zm-6-7h5V5h-5v6zm6-6v6h5V5h-5z"/></svg></button>
              <button class="memo-style-btn" data-style="compact" style="padding:4px 10px;border-radius:var(--tab-radius);border:1px solid var(--border);background:transparent;color:var(--sub);font-size:11px;font-weight:600;cursor:pointer;" title="コンパクト"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z"/></svg></button>
            </div>
          </div>
