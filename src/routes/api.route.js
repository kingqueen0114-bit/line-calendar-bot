...
// タスク完了取消し
router.post('/tasks/uncomplete', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId, taskId, listId } = req.body;
...
// メモ削除
router.delete('/memos', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// プロジェクト参加（招待コード）
router.post('/projects/join', inviteCodeRateLimit, async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// プロジェクト退出
router.post('/projects/leave', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// プロジェクトメンバー取得
router.get('/projects/members', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有カレンダーに予定作成
router.post('/shared-events', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有カレンダーの予定削除
router.delete('/shared-events', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有タスクリスト一覧取得
router.get('/shared-tasklists', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId } = req.query;
...
// 共有タスクリスト作成
router.post('/shared-tasklists', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有タスクリスト更新
router.post('/shared-tasklists/update', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有タスクリストに参加
router.post('/shared-tasklists/join', inviteCodeRateLimit, async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId, inviteCode } = req.body;
...
// 共有タスクリストから退出
router.post('/shared-tasklists/leave', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有タスクリスト削除
router.delete('/shared-tasklists', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId, listId } = req.body;
...
// 共有タスク作成
router.post('/shared-tasks', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有タスク完了
router.post('/shared-tasks/complete', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
...
// 共有タスク削除
router.delete('/shared-tasks', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId, taskId, listId } = req.body;
...
// 共有タスク完了取消し
router.post('/shared-tasks/uncomplete', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId, taskId, listId } = req.body;
...
// 完了済み共有タスク取得
router.get('/shared-tasks/completed', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId } = req.query;
...
// 同期するカレンダー設定取得
router.get('/settings/calendars', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
  const { userId } = req.query;
...
// 同期するカレンダー設定更新
router.post('/settings/calendars', async (req, res) => {
  res.set('Access-Control-Allow-Origin', '*');
